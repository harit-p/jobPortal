...
const Card = (props:any) => {
    return (
        <Link href='/job-description' className='bg-mine-shaft-900 p-4 w-72 flex flex-col gap-3 rounded-xl 
        hover:shadow-[0_0_5px_1px_yellow] !shadow-bright-sun-400'>
            ...
            }
            {
                ...
                <IconCalendarMonth stroke={1.5} className='text-bright-sun-400 w-5 h-5' /> Sun, 16 February &bull; <span className='text-mine-shaft-400'>10:00 A.M.</span>
            </div> 
            }
        </Link>
    )
