    ...
    return (
        <div className='w-2/3 m-2'>
            <div className='relative'>
             ...
             border-mine-shaft-950 border-8' src="/avatar.png" alt="avatar" />
            </div>
            <div className='px-3 mt-16'>
                <div className='text-3xl font-semibold flex justify-between'>{props.name}<Button color='#ffd149'
                    variant='light'>Message</Button></div>
